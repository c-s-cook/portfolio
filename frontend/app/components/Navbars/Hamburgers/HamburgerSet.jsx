...
import './HamburgerSet.css'
import HamburgerX01 from './HamburgerX01'


export default function HamburgerSet() {
  return (
    <>
        <HamburgerX01 />
        {/* <svg class="ham hamRotate ham1" viewBox="0 0 100 100" width="80" onClick={(e) => e.target.classList.toggle('active')}>
            <path
                class="line top"
